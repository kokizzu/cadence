...
// Source: github.com/uber/cadence/common/persistence (interfaces: ExecutionStore,ShardStore,DomainStore,TaskStore,HistoryStore,ConfigStore,DomainAuditStore,HistoryDLQTaskStore)
//
// Generated by this command:
//
//	mockgen -package persistence -destination data_store_interfaces_mock.go -self_package github.com/uber/cadence/common/persistence github.com/uber/cadence/common/persistence ExecutionStore,ShardStore,DomainStore,TaskStore,HistoryStore,ConfigStore,DomainAuditStore,HistoryDLQTaskStore
//
...
func (m *MockExecutionStore) CreateHistoryTasks(ctx context.Context, request *CreateHistoryTasksRequest) error {
	m.ctrl.T.Helper()
...
func (mr *MockExecutionStoreMockRecorder) CreateHistoryTasks(ctx, request any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateHistoryTasks", reflect.TypeOf((*MockExecutionStore)(nil).CreateHistoryTasks), ctx, request)
}
...
func (m *MockExecutionStore) DeleteActiveClusterSelectionPolicy(ctx context.Context, request *DeleteActiveClusterSelectionPolicyRequest) error {
	m.ctrl.T.Helper()
...
func (mr *MockExecutionStoreMockRecorder) DeleteActiveClusterSelectionPolicy(ctx, request any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteActiveClusterSelectionPolicy", reflect.TypeOf((*MockExecutionStore)(nil).DeleteActiveClusterSelectionPolicy), ctx, request)
}
...
func (m *MockExecutionStore) GetActiveClusterSelectionPolicy(ctx context.Context, request *GetActiveClusterSelectionPolicyRequest) (*DataBlob, error) {
	m.ctrl.T.Helper()
...
func (mr *MockExecutionStoreMockRecorder) GetActiveClusterSelectionPolicy(ctx, request any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
type MockHistoryDLQTaskStore struct {
	ctrl     *gomock.Controller
	recorder *MockHistoryDLQTaskStoreMockRecorder
	isgomock struct{}
}

// MockHistoryDLQTaskStoreMockRecorder is the mock recorder for MockHistoryDLQTaskStore.
type MockHistoryDLQTaskStoreMockRecorder struct {
	mock *MockHistoryDLQTaskStore
}

// NewMockHistoryDLQTaskStore creates a new mock instance.
func NewMockHistoryDLQTaskStore(ctrl *gomock.Controller) *MockHistoryDLQTaskStore {
	mock := &MockHistoryDLQTaskStore{ctrl: ctrl}
	mock.recorder = &MockHistoryDLQTaskStoreMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockHistoryDLQTaskStore) EXPECT() *MockHistoryDLQTaskStoreMockRecorder {
	return m.recorder
}

// Close mocks base method.
func (m *MockHistoryDLQTaskStore) Close() {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "Close")
}
...
func (mr *MockHistoryDLQTaskStoreMockRecorder) CreateHistoryDLQTask(ctx, request any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateHistoryDLQTask", reflect.TypeOf((*MockHistoryDLQTaskStore)(nil).CreateHistoryDLQTask), ctx, request)
}
...
func (mr *MockHistoryDLQTaskStoreMockRecorder) GetHistoryDLQAckLevels(ctx, request any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetHistoryDLQAckLevels", reflect.TypeOf((*MockHistoryDLQTaskStore)(nil).GetHistoryDLQAckLevels), ctx, request)
}
...
func (mr *MockHistoryDLQTaskStoreMockRecorder) GetHistoryDLQTasks(ctx, request any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetHistoryDLQTasks", reflect.TypeOf((*MockHistoryDLQTaskStore)(nil).GetHistoryDLQTasks), ctx, request)
}

// GetName mocks base method.
func (m *MockHistoryDLQTaskStore) GetName() string {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetName")
	ret0, _ := ret[0].(string)
	return ret0
...
// GetName indicates an expected call of GetName.
func (mr *MockHistoryDLQTaskStoreMockRecorder) GetName() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetName", reflect.TypeOf((*MockHistoryDLQTaskStore)(nil).GetName))
}
...
// RangeDeleteHistoryDLQTasks indicates an expected call of RangeDeleteHistoryDLQTasks.
func (mr *MockHistoryDLQTaskStoreMockRecorder) RangeDeleteHistoryDLQTasks(ctx, request any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RangeDeleteHistoryDLQTasks", reflect.TypeOf((*MockHistoryDLQTaskStore)(nil).RangeDeleteHistoryDLQTasks), ctx, request)
}

// UpdateHistoryDLQAckLevel mocks base method.
func (m *MockHistoryDLQTaskStore) UpdateHistoryDLQAckLevel(ctx context.Context, request InternalUpdateHistoryDLQAckLevelRequest) error {
	m.ctrl.T.Helper()
...
func (mr *MockHistoryDLQTaskStoreMockRecorder) UpdateHistoryDLQAckLevel(ctx, request any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateHistoryDLQAckLevel", reflect.TypeOf((*MockHistoryDLQTaskStore)(nil).UpdateHistoryDLQAckLevel), ctx, request)
}
