// Code generated by "enumer -type=ExecutorStatus,ShardStatus,AssignmentStatus,MigrationMode -trimprefix=ExecutorStatus,ShardStatus,AssignmentStatus,MigrationMode -json -output sharddistributor_statuses_enumer_generated.go"; DO NOT EDIT.
...
const _ExecutorStatusName = "INVALIDACTIVEDRAININGDRAINED"

var _ExecutorStatusIndex = [...]uint8{0, 7, 13, 21, 28}

const _ExecutorStatusLowerName = "invalidactivedrainingdrained"
...
var _ExecutorStatusNameToValueMap = map[string]ExecutorStatus{
	_ExecutorStatusName[0:7]:        ExecutorStatusINVALID,
	_ExecutorStatusLowerName[0:7]:   ExecutorStatusINVALID,
	_ExecutorStatusName[7:13]:       ExecutorStatusACTIVE,
	_ExecutorStatusLowerName[7:13]:  ExecutorStatusACTIVE,
	_ExecutorStatusName[13:21]:      ExecutorStatusDRAINING,
	_ExecutorStatusLowerName[13:21]: ExecutorStatusDRAINING,
	_ExecutorStatusName[21:28]:      ExecutorStatusDRAINED,
	_ExecutorStatusLowerName[21:28]: ExecutorStatusDRAINED,
}

var _ExecutorStatusNames = []string{
	_ExecutorStatusName[0:7],
	_ExecutorStatusName[7:13],
	_ExecutorStatusName[13:21],
	_ExecutorStatusName[21:28],
}
...
const _ShardStatusName = "INVALIDREADYDONE"

var _ShardStatusIndex = [...]uint8{0, 7, 12, 16}

const _ShardStatusLowerName = "invalidreadydone"
...
var _ShardStatusNameToValueMap = map[string]ShardStatus{
	_ShardStatusName[0:7]:        ShardStatusINVALID,
	_ShardStatusLowerName[0:7]:   ShardStatusINVALID,
	_ShardStatusName[7:12]:       ShardStatusREADY,
	_ShardStatusLowerName[7:12]:  ShardStatusREADY,
	_ShardStatusName[12:16]:      ShardStatusDONE,
	_ShardStatusLowerName[12:16]: ShardStatusDONE,
}

var _ShardStatusNames = []string{
	_ShardStatusName[0:7],
	_ShardStatusName[7:12],
	_ShardStatusName[12:16],
}
...
const _AssignmentStatusName = "INVALIDREADY"

var _AssignmentStatusIndex = [...]uint8{0, 7, 12}

const _AssignmentStatusLowerName = "invalidready"
...
var _AssignmentStatusNameToValueMap = map[string]AssignmentStatus{
	_AssignmentStatusName[0:7]:       AssignmentStatusINVALID,
	_AssignmentStatusLowerName[0:7]:  AssignmentStatusINVALID,
	_AssignmentStatusName[7:12]:      AssignmentStatusREADY,
	_AssignmentStatusLowerName[7:12]: AssignmentStatusREADY,
}

var _AssignmentStatusNames = []string{
	_AssignmentStatusName[0:7],
	_AssignmentStatusName[7:12],
}
...
const _MigrationModeName = "INVALIDLOCALPASSTHROUGHLOCALPASSTHROUGHSHADOWDISTRIBUTEDPASSTHROUGHONBOARDED"

var _MigrationModeIndex = [...]uint8{0, 7, 23, 45, 67, 76}

const _MigrationModeLowerName = "invalidlocalpassthroughlocalpassthroughshadowdistributedpassthroughonboarded"
...
var _MigrationModeNameToValueMap = map[string]MigrationMode{
	_MigrationModeName[0:7]:        MigrationModeINVALID,
	_MigrationModeLowerName[0:7]:   MigrationModeINVALID,
	_MigrationModeName[7:23]:       MigrationModeLOCALPASSTHROUGH,
	_MigrationModeLowerName[7:23]:  MigrationModeLOCALPASSTHROUGH,
	_MigrationModeName[23:45]:      MigrationModeLOCALPASSTHROUGHSHADOW,
	_MigrationModeLowerName[23:45]: MigrationModeLOCALPASSTHROUGHSHADOW,
	_MigrationModeName[45:67]:      MigrationModeDISTRIBUTEDPASSTHROUGH,
	_MigrationModeLowerName[45:67]: MigrationModeDISTRIBUTEDPASSTHROUGH,
	_MigrationModeName[67:76]:      MigrationModeONBOARDED,
	_MigrationModeLowerName[67:76]: MigrationModeONBOARDED,
}

var _MigrationModeNames = []string{
	_MigrationModeName[0:7],
	_MigrationModeName[7:23],
	_MigrationModeName[23:45],
	_MigrationModeName[45:67],
	_MigrationModeName[67:76],
}
